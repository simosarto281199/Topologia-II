...
\begin{definition}+
  ...
  \end{equation*}
  are isomorphisms.
  The pairing is called \vocab{non-degenerate} if the $\Psi_i$ are injective.
  If  $P=N$, a perfect pairing is called a \vocab{unimodular form} on $P$.
\end{definition}
\todoquestion{how is the adjunction?}
